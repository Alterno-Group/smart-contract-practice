...
<h2>Deploy and verify your first ERC20 token and ERC721 NFT contracts on Lisk Sepolia</h2>
This repo is a fork of [Scaffold-Lisk](https://github.com/LiskHQ/scaffold-lisk).
Following Scaffold-Lisk guideline, we create and deploy smart contracts (ERC-20 and ERC-721) and build a simple user interfaces that interact with our contracts.
